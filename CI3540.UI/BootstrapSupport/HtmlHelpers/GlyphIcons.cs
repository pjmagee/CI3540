...
namespace CI3540.UI.BootstrapSupport.HtmlHelpers
{
    public static class GlyphIcons
    {
        ...
        public static MvcHtmlString ActionLinkWithGlyphIcon(this HtmlHelper helper, string action, string text, string glyphs, string tooltip = "", IDictionary<string, object> htmlAttributes = null)
        {
    ...
    #region icon constants
        ...
        public const string user = "icon-users";
