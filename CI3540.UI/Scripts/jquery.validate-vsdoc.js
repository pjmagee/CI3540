...
$.extend($.fn, {
	// http://docs.jquery.com/Plugins/Validation/valiDateCreated
	validate: function( options ) {
		/// <summary>
		/// ValiDateCreateds the selected form. This method sets up event handlers for submit, focus,
		...
		/// A set of key/value pairs that configure the valiDateCreated. All options are optional.
		/// </param>

		// if nothing is selected, return nothing; can't chain anyway
		if (!this.length) {
			options && options.debug && window.console && console.warn( "nothing selected, can't valiDateCreated, returning nothing" );
			return;
		}
		...
		if ( validator.settings.onsubmit ) {
			...
			// valiDateCreated the form on submit
	...
	valid: function() {
		...
		/// valiDateCreated() needs to be called on the form before checking it using this method.
		/// </summary>
...
$.extend($.validator, {
	...
	setDefaults: function(settings) {
		...
		/// Accepts everything that Plugins/Validation/valiDateCreated accepts.
		/// </summary>
	...
	messages: {
		...
		date: "Please enter a valid DateCreated.",
		dateISO: "Please enter a valid DateCreated (ISO).",
	...
	prototype: {
		...
		init: function() {
			...
			function delegate(event) {
				var validator = $.data(this[0].form, "validator"),
					eventType = "on" + event.type.replace(/^valiDateCreated/, "");
			...
			if (this.settings.invalidHandler)
				$(this.currentForm).bind("invalid-form.valiDateCreated", this.settings.invalidHandler);
		},

		// http://docs.jquery.com/Plugins/Validation/Validator/form
		form: function() {
			/// <summary>
			/// ValiDateCreateds the form, returns true if it is valid, false otherwise.
		...
		element: function( element ) {
			/// <summary>
			/// ValiDateCreateds a single element, returns true if it is valid, false otherwise.
			/// This behaves as validation on blur or keyup, but returns the result.
			/// </summary>
			/// <param name="element" type="Selector">
			/// An element to valiDateCreated, must be inside the valiDateCreatedd form.
			/// </param>
			/// <returns type="Boolean" />
		...
		check: function( element ) {
			...
			// if radio/checkbox, valiDateCreated first element in group instead
	...
	methods: {
		...
		remote: function(value, element, param) {
			...
			$.ajax($.extend(true, {
				url: param,
				mode: "abort",
				port: "valiDateCreated" + element.name,
				dataType: "json",
				data: data,
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/DateCreated
		date: function(value, element) {
			return this.optional(element) || !/Invalid|NaN/.test(new Date(value));
		},
	
		// http://docs.jquery.com/Plugins/Validation/Methods/DateCreatedISO
		...
		equalTo: function(value, element, param) {
			// bind to the blur event of the target in order to revaliDateCreated whenever the target field is upDateCreatedd
			// TODO find a way to bind the event just once, avoiding the unbind-rebind overhead
			var target = $(param).unbind(".valiDateCreated-equalTo").bind("blur.valiDateCreated-equalTo", function() {
				$(element).valid();
			});
